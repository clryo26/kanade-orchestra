...
JSON_COLLECTION_TABLES = {
    ...
    "albums": "albums",
    "concert_record_videos": "concert_record_videos",
    "part_settings": "part_settings",
    "venue_settings": "venue_settings",
    "flyer_distributions": "flyer_distributions",
    "flyer_distribution_assignments": "flyer_distribution_assignments",
...
DB_COLLECTION_COLUMNS = {
    ...
    "flyer_distributions": ("id", "facility_name", "area_address", "note", "created_at", "updated_at"),
    "flyer_distribution_assignments": (
        "id",
        "performance_id",
        "flyer_distribution_id",
        "planned_member_id",
        "planned_member_name",
        "planned_date",
        "distributed_member_id",
        "distributed_member_name",
        "distributed_date",
        "note",
        "created_at",
        "updated_at",
...
DB_DATE_COLUMNS = {
    ...
    "flyer_distribution_assignments": {"planned_date", "distributed_date"},
}
...
DB_INT_COLUMNS = {
    ...
    "announcements": {"id"},
    "events": {"id", "created_by_member_id"},
    "members": {"id"},
    ...
    "concert_record_videos": {"id", "performance_id", "sort_order"},
